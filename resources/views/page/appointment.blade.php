            ...
            <form action="{{ route('reservations.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    ...
                    <div class="doctor-options">
                        <label><input type="radio" name="doctor" value="0" {{ old('doctor') == '0' ? 'checked' : '' }} /> Beautician</label>
                        <label><input type="radio" name="doctor" value="1" {{ old('doctor') == '1' ? 'checked' : '' }} /> Aesthetic Doctor</label>
                    </div>
                </div>
